...
public interface AuctionRepository extends JpaRepository<Auction,Integer> {
	...
	@Query(value =  "Select auctionid,vendorid,fpid,biddingprice,quantity,biddate from auction where fpid=?1 and biddingprice =(Select max(biddingprice) from auction where fpid= ?1);" ,nativeQuery = true)
